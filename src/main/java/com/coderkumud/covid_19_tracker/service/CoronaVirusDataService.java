package com.coderkumud.covid_19_tracker.service;
...
public class CoronaVirusDataService {
    ...
    public void fetchVirusData() throws IOException, InterruptedException {
        ...
        HttpRequest request = HttpRequest.newBuilder(URI.create(VIRUS_DATA_URL))
                .build();
        ...
        for (CSVRecord record : records) {
            ...
            stats.setDiffFromPreviousDay(latestCases - previousCases);
            newStats.add(stats);
        }
